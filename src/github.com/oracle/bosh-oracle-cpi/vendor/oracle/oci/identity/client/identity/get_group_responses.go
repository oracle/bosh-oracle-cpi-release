...
func (o *GetGroupBadRequest) Error() string {
	return fmt.Sprintf("[GET /groups/{groupId}][%d] getGroupBadRequest  %+v", 400, o.Payload)
}
...
func (o *GetGroupForbidden) Error() string {
	return fmt.Sprintf("[GET /groups/{groupId}][%d] getGroupForbidden  %+v", 403, o.Payload)
}
...
func (o *GetGroupNotFound) Error() string {
	return fmt.Sprintf("[GET /groups/{groupId}][%d] getGroupNotFound  %+v", 404, o.Payload)
}
...
func (o *GetGroupInternalServerError) Error() string {
	return fmt.Sprintf("[GET /groups/{groupId}][%d] getGroupInternalServerError  %+v", 500, o.Payload)
}
...
func (o *GetGroupDefault) Error() string {
	return fmt.Sprintf("[GET /groups/{groupId}][%d] GetGroup default  %+v", o._statusCode, o.Payload)
}
