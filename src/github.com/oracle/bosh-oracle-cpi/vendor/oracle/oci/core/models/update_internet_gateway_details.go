...
func (m *UpdateInternetGatewayDetails) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *UpdateInternetGatewayDetails) UnmarshalBinary(b []byte) error {
	var res UpdateInternetGatewayDetails
