...
func (m *CrossConnectGroup) validateTimeCreated(formats strfmt.Registry) error {
...
func (m *CrossConnectGroup) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CrossConnectGroup) UnmarshalBinary(b []byte) error {
	var res CrossConnectGroup
