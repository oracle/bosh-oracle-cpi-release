...
func (m *UpdateVirtualCircuitDetails) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *UpdateVirtualCircuitDetails) UnmarshalBinary(b []byte) error {
	var res UpdateVirtualCircuitDetails
