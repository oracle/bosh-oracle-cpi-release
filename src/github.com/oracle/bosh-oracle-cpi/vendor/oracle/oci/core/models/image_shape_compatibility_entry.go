...
func (m *ImageShapeCompatibilityEntry) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ImageShapeCompatibilityEntry) UnmarshalBinary(b []byte) error {
	var res ImageShapeCompatibilityEntry
