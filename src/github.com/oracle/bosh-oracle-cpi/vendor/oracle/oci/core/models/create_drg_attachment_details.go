...
func (m *CreateDrgAttachmentDetails) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CreateDrgAttachmentDetails) UnmarshalBinary(b []byte) error {
	var res CreateDrgAttachmentDetails
