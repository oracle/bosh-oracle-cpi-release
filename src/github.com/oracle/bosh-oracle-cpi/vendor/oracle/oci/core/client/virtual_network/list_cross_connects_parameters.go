...
// WithDisplayName adds the displayName to the list cross connects params
func (o *ListCrossConnectsParams) WithDisplayName(displayName *string) *ListCrossConnectsParams {
	o.SetDisplayName(displayName)
	return o
}

// SetDisplayName adds the displayName to the list cross connects params
func (o *ListCrossConnectsParams) SetDisplayName(displayName *string) {
	o.DisplayName = displayName
}

// WithLifecycleState adds the lifecycleState to the list cross connects params
func (o *ListCrossConnectsParams) WithLifecycleState(lifecycleState *string) *ListCrossConnectsParams {
	o.SetLifecycleState(lifecycleState)
	return o
}

// SetLifecycleState adds the lifecycleState to the list cross connects params
func (o *ListCrossConnectsParams) SetLifecycleState(lifecycleState *string) {
...
// WithSortBy adds the sortBy to the list cross connects params
func (o *ListCrossConnectsParams) WithSortBy(sortBy *string) *ListCrossConnectsParams {
	o.SetSortBy(sortBy)
	return o
}

// SetSortBy adds the sortBy to the list cross connects params
func (o *ListCrossConnectsParams) SetSortBy(sortBy *string) {
	o.SortBy = sortBy
}

// WithSortOrder adds the sortOrder to the list cross connects params
func (o *ListCrossConnectsParams) WithSortOrder(sortOrder *string) *ListCrossConnectsParams {
	o.SetSortOrder(sortOrder)
	return o
}

// SetSortOrder adds the sortOrder to the list cross connects params
func (o *ListCrossConnectsParams) SetSortOrder(sortOrder *string) {
