...
func (m *LaunchInstanceDetails) SourceDetails() InstanceSourceDetails {
	return m.sourceDetailsField
}
func (m *LaunchInstanceDetails) SetSourceDetails(val InstanceSourceDetails) {
	m.sourceDetailsField = val
}

// UnmarshalJSON unmarshals this object with a polymorphic type from a JSON structure
func (m *LaunchInstanceDetails) UnmarshalJSON(raw []byte) error {
	var data struct {
		AvailabilityDomain *string `json:"availabilityDomain"`
	...
	var result LaunchInstanceDetails
	...
	// createVnicDetails
	result.CreateVnicDetails = data.CreateVnicDetails
	...
	// hostnameLabel
	result.HostnameLabel = data.HostnameLabel
...
func (m LaunchInstanceDetails) MarshalJSON() ([]byte, error) {
	var b1, b2, b3 []byte
	var err error
	b1, err = json.Marshal(struct {
		...
		CreateVnicDetails: m.CreateVnicDetails,
...
func (m *LaunchInstanceDetails) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *LaunchInstanceDetails) UnmarshalBinary(b []byte) error {
	var res LaunchInstanceDetails
