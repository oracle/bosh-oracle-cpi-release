...
func (m *DrgAttachment) validateTimeCreated(formats strfmt.Registry) error {
...
func (m *DrgAttachment) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *DrgAttachment) UnmarshalBinary(b []byte) error {
	var res DrgAttachment
