...
func (m *CreateSecurityListDetails) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CreateSecurityListDetails) UnmarshalBinary(b []byte) error {
	var res CreateSecurityListDetails
