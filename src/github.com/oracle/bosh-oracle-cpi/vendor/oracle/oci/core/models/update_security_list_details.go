...
func (m *UpdateSecurityListDetails) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *UpdateSecurityListDetails) UnmarshalBinary(b []byte) error {
	var res UpdateSecurityListDetails
