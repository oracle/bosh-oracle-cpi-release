...
type CreateImageParams struct {
	...
	*/
	CreateImageDetails *models.CreateImageDetails
	/*OpcRetryToken
...
// WithCreateImageDetails adds the createImageDetails to the create image params
func (o *CreateImageParams) WithCreateImageDetails(createImageDetails *models.CreateImageDetails) *CreateImageParams {
	o.SetCreateImageDetails(createImageDetails)
	return o
}

// SetCreateImageDetails adds the createImageDetails to the create image params
func (o *CreateImageParams) SetCreateImageDetails(createImageDetails *models.CreateImageDetails) {
	o.CreateImageDetails = createImageDetails
}

// WithOpcRetryToken adds the opcRetryToken to the create image params
func (o *CreateImageParams) WithOpcRetryToken(opcRetryToken *string) *CreateImageParams {
	o.SetOpcRetryToken(opcRetryToken)
	return o
}

// SetOpcRetryToken adds the opcRetryToken to the create image params
func (o *CreateImageParams) SetOpcRetryToken(opcRetryToken *string) {
...
func (o *CreateImageParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.CreateImageDetails == nil {
		o.CreateImageDetails = new(models.CreateImageDetails)
	}

	if err := r.SetBodyParam(o.CreateImageDetails); err != nil {
		return err
	}
