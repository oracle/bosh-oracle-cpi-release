...
func (m *UpdateDhcpDetails) Options() []DhcpOption {
	return m.optionsField
}
func (m *UpdateDhcpDetails) SetOptions(val []DhcpOption) {
	m.optionsField = val
}
...
func (m *UpdateDhcpDetails) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *UpdateDhcpDetails) UnmarshalBinary(b []byte) error {
	var res UpdateDhcpDetails
