...
func (m *CreateCrossConnectDetails) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CreateCrossConnectDetails) UnmarshalBinary(b []byte) error {
	var res CreateCrossConnectDetails
