...
// WithDisplayName adds the displayName to the list cross connect groups params
func (o *ListCrossConnectGroupsParams) WithDisplayName(displayName *string) *ListCrossConnectGroupsParams {
	o.SetDisplayName(displayName)
	return o
}

// SetDisplayName adds the displayName to the list cross connect groups params
func (o *ListCrossConnectGroupsParams) SetDisplayName(displayName *string) {
	o.DisplayName = displayName
}

// WithLifecycleState adds the lifecycleState to the list cross connect groups params
func (o *ListCrossConnectGroupsParams) WithLifecycleState(lifecycleState *string) *ListCrossConnectGroupsParams {
	o.SetLifecycleState(lifecycleState)
	return o
}

// SetLifecycleState adds the lifecycleState to the list cross connect groups params
func (o *ListCrossConnectGroupsParams) SetLifecycleState(lifecycleState *string) {
...
// WithSortBy adds the sortBy to the list cross connect groups params
func (o *ListCrossConnectGroupsParams) WithSortBy(sortBy *string) *ListCrossConnectGroupsParams {
	o.SetSortBy(sortBy)
	return o
}

// SetSortBy adds the sortBy to the list cross connect groups params
func (o *ListCrossConnectGroupsParams) SetSortBy(sortBy *string) {
	o.SortBy = sortBy
}

// WithSortOrder adds the sortOrder to the list cross connect groups params
func (o *ListCrossConnectGroupsParams) WithSortOrder(sortOrder *string) *ListCrossConnectGroupsParams {
	o.SetSortOrder(sortOrder)
	return o
}

// SetSortOrder adds the sortOrder to the list cross connect groups params
func (o *ListCrossConnectGroupsParams) SetSortOrder(sortOrder *string) {
