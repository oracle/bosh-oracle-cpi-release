...
// swagger:model EgressSecurityRule
...
// Validate validates this egress security rule
func (m *EgressSecurityRule) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *EgressSecurityRule) validateDestination(formats strfmt.Registry) error {
...
func (m *EgressSecurityRule) validateIcmpOptions(formats strfmt.Registry) error {
...
func (m *EgressSecurityRule) validateProtocol(formats strfmt.Registry) error {
...
func (m *EgressSecurityRule) validateTCPOptions(formats strfmt.Registry) error {
...
func (m *EgressSecurityRule) validateUDPOptions(formats strfmt.Registry) error {
...
func (m *EgressSecurityRule) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *EgressSecurityRule) UnmarshalBinary(b []byte) error {
	var res EgressSecurityRule
