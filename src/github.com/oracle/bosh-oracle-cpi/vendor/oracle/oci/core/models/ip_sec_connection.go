...
func (m *IPSecConnection) validateTimeCreated(formats strfmt.Registry) error {
...
func (m *IPSecConnection) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *IPSecConnection) UnmarshalBinary(b []byte) error {
	var res IPSecConnection
